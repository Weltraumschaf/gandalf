...
#define PACKAGE_STRING "PostgreSQL 9.1.11"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "postgresql"

/* Define to the version of this package. */
#define PACKAGE_VERSION "9.1.11"
...
#define PG_VERSION "9.1.11"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 90111

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 9.1.11 on x86_64-unknown-linux-gnu, compiled by gcc (Debian 4.7.2-5) 4.7.2, 64-bit"
